...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_avalon_st_adapter_007_error_adapter_0.sv \
  ...
  $QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_avalon_st_adapter_007.v \
  ...
  $QSYS_SIMDIR/submodules/Embed_mm_interconnect_0_rsp_demux_004.sv \
