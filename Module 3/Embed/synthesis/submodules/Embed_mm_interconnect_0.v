...
module Embed_mm_interconnect_0 (
	...
	wire          cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> altpll_1_pll_slave_agent:cp_valid
	wire  [112:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> altpll_1_pll_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // altpll_1_pll_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [10:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> altpll_1_pll_slave_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> altpll_1_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> altpll_1_pll_slave_agent:cp_endofpacket
	...
	wire  [112:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> altpll_0_pll_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // altpll_0_pll_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [10:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> altpll_0_pll_slave_agent:cp_channel
	...
	wire  [112:0] altpll_1_pll_slave_agent_rp_data;                                                   // altpll_1_pll_slave_agent:rp_data -> router_006:sink_data
	...
	wire          altpll_1_pll_slave_agent_rdata_fifo_out_valid;                                      // altpll_1_pll_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] altpll_1_pll_slave_agent_rdata_fifo_out_data;                                       // altpll_1_pll_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          altpll_1_pll_slave_agent_rdata_fifo_out_ready;                                      // avalon_st_adapter_003:in_0_ready -> altpll_1_pll_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> altpll_1_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> altpll_1_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                                  // altpll_1_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> altpll_1_pll_slave_agent:rdata_fifo_sink_error
	...
	Embed_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_1_clk_clk),                                              //       clk.clk
		.reset              (altpll_1_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Embed_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                              //       clk.clk
		.reset              (altpll_0_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
